...
public class CongresosDocentes extends Categoria implements Serializable
{
            ...
            List<ParticipacionCongreso> participacionCongresos, Plantilla plantilla)
    {
        ...
        else if (plantilla.getCongresosDocentes().getMaxAnyos() != 0)
        {
            participacionCongresosFiltrado = aplicaFiltroAnyos(participacionCongresos, plantilla
                    .getCongresosDocentes().getMaxAnyos());
        }
        else if (plantilla.getCongresosDocentes().getMaxItems() != 0)
        {
            participacionCongresosFiltrado = aplicaFiltroItems(participacionCongresos, plantilla
                    .getCongresosDocentes().getMaxItems());
        }
